import{v as U}from"./v4-CtRu48qb.js";import{d as q,b as p,e as w,u as G,f as E,g as z,o as I,m as T,v as $,n as H}from"./vue.esm-bundler--cmgGqvu.js";const{addons:J}=__STORYBOOK_MODULE_PREVIEW_API__,{ImplicitActionsDuringRendering:Q}=__STORYBOOK_MODULE_CORE_EVENTS_PREVIEW_ERRORS__,{global:F}=__STORYBOOK_MODULE_GLOBAL__;var X=Object.defineProperty,Z=(t,e)=>{for(var n in e)X(t,n,{get:e[n],enumerable:!0})},ee="storybook/actions",ne=`${ee}/action-event`,te={depth:10,clearOnStoryChange:!0,limit:50},K=(t,e)=>{let n=Object.getPrototypeOf(t);return!n||e(n)?n:K(n,e)},ae=t=>!!(typeof t=="object"&&t&&K(t,e=>/^Synthetic(?:Base)?Event$/.test(e.constructor.name))&&typeof t.persist=="function"),re=t=>{if(ae(t)){let e=Object.create(t.constructor.prototype,Object.getOwnPropertyDescriptors(t));e.persist();let n=Object.getOwnPropertyDescriptor(e,"view"),r=n==null?void 0:n.value;return typeof r=="object"&&(r==null?void 0:r.constructor.name)==="Window"&&Object.defineProperty(e,"view",{...n,value:Object.create(r.constructor.prototype)}),e}return t},oe=()=>typeof crypto=="object"&&typeof crypto.getRandomValues=="function"?U():Date.now().toString(36)+Math.random().toString(36).substring(2);function V(t,e={}){let n={...te,...e},r=function(...u){var _,h;if(e.implicit){let m=(_="__STORYBOOK_PREVIEW__"in F?F.__STORYBOOK_PREVIEW__:void 0)==null?void 0:_.storyRenders.find(a=>a.phase==="playing"||a.phase==="rendering");if(m){let a=!((h=globalThis==null?void 0:globalThis.FEATURES)!=null&&h.disallowImplicitActionsInRenderV8),o=new Q({phase:m.phase,name:t,deprecated:a});if(a)console.warn(o);else throw o}}let i=J.getChannel(),l=oe(),d=5,c=u.map(re),O=u.length>1?c:c[0],x={id:l,count:0,data:{name:t,args:O},options:{...n,maxDepth:d+(n.depth||3),allowFunction:n.allowFunction||!1}};i.emit(ne,x)};return r.isAction=!0,r.implicit=e.implicit,r}const{definePreview:be}=__STORYBOOK_MODULE_PREVIEW_API__,{global:R}=__STORYBOOK_MODULE_GLOBAL__;var se={};Z(se,{argsEnhancers:()=>le,loaders:()=>ce});var W=(t,e)=>typeof e[t]>"u"&&!(t in e),ie=t=>{let{initialArgs:e,argTypes:n,id:r,parameters:{actions:u}}=t;if(!u||u.disable||!u.argTypesRegex||!n)return{};let i=new RegExp(u.argTypesRegex);return Object.entries(n).filter(([l])=>!!i.test(l)).reduce((l,[d,c])=>(W(d,e)&&(l[d]=V(d,{implicit:!0,id:r})),l),{})},ue=t=>{let{initialArgs:e,argTypes:n,parameters:{actions:r}}=t;return r!=null&&r.disable||!n?{}:Object.entries(n).filter(([u,i])=>!!i.action).reduce((u,[i,l])=>(W(i,e)&&(u[i]=V(typeof l.action=="string"?l.action:i)),u),{})},le=[ue,ie],L=!1,de=t=>{let{parameters:{actions:e}}=t;if(!(e!=null&&e.disable)&&!L&&"__STORYBOOK_TEST_ON_MOCK_CALL__"in R&&typeof R.__STORYBOOK_TEST_ON_MOCK_CALL__=="function"){let n=R.__STORYBOOK_TEST_ON_MOCK_CALL__;n((r,u)=>{let i=r.getMockName();i!=="spy"&&(!/^next\/.*::/.test(i)||["next/router::useRouter()","next/navigation::useRouter()","next/navigation::redirect","next/cache::","next/headers::cookies().set","next/headers::cookies().delete","next/headers::headers().set","next/headers::headers().delete"].some(l=>i.startsWith(l)))&&V(i)(u)}),L=!0}},ce=[de];const pe=["value"],y=q({__name:"vue-num-locale-input",props:{modelValue:{},options:{default:()=>({})}},emits:["update:modelValue"],setup(t,{emit:e}){const n=t,r=e,u=p("text"),i=p(null),l=w(()=>typeof n.modelValue=="number"?n.modelValue.toLocaleString(void 0,n.options):""),d=a=>{if(!a||typeof a!="string"||(a=a.trim(),!a))return null;let o=parseFloat(a);if(!isNaN(o))return o;let s=a.replace(",",".");return o=parseFloat(s),!isNaN(o)||(s=a.replace(/\s+/g,"").replace(/,(\d{3})/g,"$1").replace(",","."),o=parseFloat(s),!isNaN(o))?o:null},c=w({get:()=>n.modelValue,set:a=>{if(typeof a=="string"){const o=d(a);o!==null&&r("update:modelValue",o);return}a!=null&&!Number.isNaN(a)&&r("update:modelValue",a)}}),O=a=>{const o=a.target,s=a.key,f=o.selectionStart??0,Y=o.selectionEnd??0,N=f!==Y;s==="Backspace"||s==="Delete"||s==="Tab"||s==="Escape"||s==="Enter"||s==="Home"||s==="End"||s.startsWith("Arrow")||a.ctrlKey||a.metaKey||/^[0-9]$/.test(s)||(s==="."||s===",")&&(N||!o.value.includes(".")&&!o.value.includes(","))||s==="-"&&(f===0||N&&f===0||o.value.toLowerCase().endsWith("e"))||s==="+"&&(f===0||N&&f===0||o.value.toLowerCase().endsWith("e"))||(s==="e"||s==="E")&&o.value.length>0&&!o.value.toLowerCase().includes("e")||a.preventDefault()},x=async()=>{u.value="number",await H(),i.value instanceof HTMLInputElement&&i.value.focus()},_=()=>{u.value="text"},h=G(),m=w(()=>{const{type:a,value:o,...s}=h;return s});return(a,o)=>u.value==="text"?(I(),E("input",T({key:0,type:"text"},m.value,{readonly:"",value:l.value,onFocus:x}),null,16,pe)):z((I(),E("input",T({key:1,type:"number"},m.value,{"onUpdate:modelValue":o[0]||(o[0]=s=>c.value=s),onKeydown:O,onFocusout:_,ref_key:"inpnum",ref:i}),null,16)),[[$,c.value]])}});y.__docgenInfo={exportName:"default",displayName:"vue-num-locale-input",type:1,props:[{name:"modelValue",global:!1,description:"Numeric model value",tags:[],required:!1,type:"number | undefined",declarations:[],schema:{kind:"enum",type:"number | undefined",schema:["undefined","number"]}},{name:"options",global:!1,description:"Options for Intl.NumberFormat",tags:[{name:"see",text:"https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat/NumberFormat#options"}],required:!1,type:"Record<string, unknown> | undefined",declarations:[],schema:{kind:"enum",type:"Record<string, unknown> | undefined",schema:["undefined","Record<string, unknown>"]},default:"{}"},{name:"key",global:!0,description:"",tags:[],required:!1,type:"PropertyKey | undefined",declarations:[],schema:{kind:"enum",type:"PropertyKey | undefined",schema:["undefined","string","number","symbol"]}},{name:"ref",global:!0,description:"",tags:[],required:!1,type:"VNodeRef | undefined",declarations:[],schema:{kind:"enum",type:"VNodeRef | undefined",schema:["undefined","string","Ref<any, any>",{kind:"event",type:"(ref: Element | ComponentPublicInstance<{}, {}, {}, {}, {}, {}, {}, {}, false, ComponentOptionsBase<any, any, any, any, any, any, any, any, any, {}, {}, string, {}, {}, {}, string, ComponentProvideOptions>, ... 4 more ..., any> | null, refs: Record<...>): void"}]}},{name:"ref_for",global:!0,description:"",tags:[],required:!1,type:"boolean | undefined",declarations:[],schema:{kind:"enum",type:"boolean | undefined",schema:["undefined","false","true"]}},{name:"ref_key",global:!0,description:"",tags:[],required:!1,type:"string | undefined",declarations:[],schema:{kind:"enum",type:"string | undefined",schema:["undefined","string"]}},{name:"class",global:!0,description:"",tags:[],required:!1,type:"unknown",declarations:[],schema:"unknown"},{name:"style",global:!0,description:"",tags:[],required:!1,type:"unknown",declarations:[],schema:"unknown"}],events:[{name:"update:modelValue",description:"Emits when value is changed and is valid number",tags:[],type:"[value: number]",signature:'(event: "update:modelValue", value: number): void',declarations:[],schema:["number"]}],slots:[],exposed:[{name:"options",type:"Record<string, unknown>",description:"Options for Intl.NumberFormat",declarations:[],schema:"Record<string, unknown>"},{name:"modelValue",type:"number | undefined",description:"Numeric model value",declarations:[],schema:{kind:"enum",type:"number | undefined",schema:["undefined","number"]}}],sourceFiles:"C:/Users/radek.svitil/Documents/github/vue-num-locale-input/src/lib-components/vue-num-locale-input.vue"};const me={component:y},g={decorators:[()=>({template:`
    ...
    `}),args:{min:-2,max:2e4,options:{notation:"scientific"}}},v={name:"Three fields as Bootstrap Input Group",render:t=>({components:{VueNumLocaleInput:y},data(){return{secondValue:-273.15}},setup(){let e=p(12);return{args:t,firstValue:e,updateFirstValue:r=>e.value=r}},template:`
  ...
  </div>,`}),args:{step:1,max:20,min:-10,class:"form-control",options:{minimumFractionDigits:void 0,maximumFractionDigits:void 0}}},b={render:t=>({components:{VueNumLocaleInput:y},setup(){let e=p([]);const n=-1e7,r=1e7;for(let u=0;u<10;u++){let i=[];for(let l=0;l<4;l++)i.push(p(Math.random()*(r-n+1)+n));e.value.push(i)}return{args:t,numArray:e}},template:`
